...
export const StockOut: React.FC = () => {
  ...
  if (items.length === 0 || vehicles.length === 0) {
    return (
      <div className="p-4 sm:p-6 lg:p-8 max-w-lg mx-auto bg-card rounded-lg shadow-md mt-10 text-center">
        <h2 className="text-2xl font-bold text-textPrimary mb-4">Stock Out Transaction</h2>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      <h2 className="text-2xl sm:text-3xl font-bold text-textPrimary mb-6 text-center">Stock Out Transaction</h2>
